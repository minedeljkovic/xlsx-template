...
module.exports = (function() {
    ...
    Workbook.prototype.stringify = function (value) {
        ...
        if(value instanceof Date) {
            ...
            // To write local time to excel, UTC time is corrected with time zone offset
            var correctedLocaleTime = value.getTime() - (value.getTimezoneOffset() * 60 * 1000);
            return Number( (correctedLocaleTime/(1000*60*60*24)) + 25569);
